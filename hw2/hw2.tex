...
\begin{center}
  \begin{tabular}{| l | r | r | r | r |}
    ...
    \texttt{test-02-in.txt} & 1min 4sec & 20sec (3.20x) & 23sec (2.84x) & 18sec (3.55x) \\ \hline
    \texttt{test-03-in.txt} & 23min 22sec & 5min (4.67x) & 6min 56sec (3.37x) & 4min 39sec (5.02x) \\ \hline
    \texttt{test-04-in.txt} & 16min 23sec & 2min 30sec (6.55x) & 2min 52sec (5.72x) & 2min 45sec (5.97x) \\
    \hline
  \end{tabular}
\end{center}
